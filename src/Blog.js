                ...
                <div className="blog">
                    ...
                    <div className="container my3">
                        ...
                        <div className="col-xs-12 col-md-10">
                            ...
                            <p>While microblading involves needles, everyone experiences pain differently. Thankfully, there’s a way to make sure that pain is as minimal as possible. While some people who’ve had microblading said it didn’t hurt at all (or that it felt like having their brows <a style={{textDecoration: 'none'}} href="http://www.cosmopolitan.com/style-beauty/beauty/a3884218/eyebrow-microblading-semi-permanent-tattoos/">threaded</a>), others said it hurt <a style={{textDecoration: 'none'}} href="http://www.cosmopolitan.com/uk/beauty-hair/beauty-trends/a44101/microblading-review-before-after/">a lot</a>. If you want to make sure your microblading treatment is as pain-free as possible, using a topical <a style={{textDecoration: 'none'}} href="https://zensaskincare.com/shop/zensa-numbing-cream-30g">numbing cream</a> won’t affect the ink or healing process and can significantly reduce the pain you might feel during the procedure. Who says beauty has to be painful?</p>
