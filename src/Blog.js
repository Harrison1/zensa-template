                ...
                <div className="blog">
                    ...
                    <div className="container">
                        <div className="row center-xs">
                            ...
                            <p><center>Whether your tattoo quotes literature or rap lyrics, you'll need the perfect lettering to make your ink look incredible. Here's your go-to guide to our favorite tattoo fonts.</center></p>
                        </div>
                    </div>
                    {/* end: headline */}
